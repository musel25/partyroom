...
export function GuestPrompt({ code }: { code: string }) {
  return (
    <main className="min-h-screen flex items-center justify-center bg-duo-cream p-6">
      <div className="bg-white rounded-2xl p-8 max-w-sm w-full border-b-[4px] border-duo-border">
        ...
        <form action={claimGuestName} className="space-y-3">
          ...
          <input
            ...
            className="w-full rounded-xl px-4 py-3 bg-duo-soft focus:outline-none focus:bg-white border-2 border-transparent focus:border-duo-green"
          />
